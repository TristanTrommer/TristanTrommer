  ...
  return (
    <main className="flex flex-col items-center px-4">
      ...
      >
        ...
        <h2 className="mb-4 text-3xl font-medium">Disclaimer</h2>

        <h3 className="mb-2 text-2xl font-medium">Liability for content</h3>
        <p className="mb-4">
        ...
        <h3 className="mb-2 text-2xl font-medium">Liability for links</h3>
        <p className="mb-4">
        ...
        <h3 className="mb-2 text-2xl font-medium">Copyright</h3>
        <p className="mb-4">
        ...
        <h3 className="mb-2 text-2xl font-medium">Social media profiles</h3>
        <p className="mb-8">
